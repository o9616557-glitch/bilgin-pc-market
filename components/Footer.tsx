      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 w-full">
        ...
        <div className="border-t border-slate-800/80 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
         ...
         <div className="flex items-center justify-center md:justify-start gap-4">
            <img 
              src="https://res.cloudinary.com/dtnbkoa9s/image/upload/q_auto/f_auto/v1781544026/iyzico_blue-1024x576_kl0i8d.png" 
              alt="iyzico" 
              loading="lazy" 
              className="h-8 object-contain" 
            />
            <img 
              src="https://res.cloudinary.com/dtnbkoa9s/image/upload/q_auto/f_auto/v1781544625/WhatsApp-Image-2025-07-18-at-12.03.53-1200x675_hpqyxg.png" 
              alt="Visa Mastercard" 
              loading="lazy" 
              className="h-8 object-contain" 
            />
