    ...
    <footer className={`bg-[#09090b] border-t border-slate-800/80 pt-16 relative overflow-hidden flex flex-col items-center ${pathname?.includes('/product') ? 'pb-40 md:pb-8' : 'pb-8'}`}>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* 1. Sütun: Sadece Logo ve Açıklama */}
          ...
          {/* 4. Sütun: Mobil Uygulama ve TAKİP EDİN (Razer Tarzı) */}
          <div className="flex flex-col gap-8">
            ...
            {/* Sosyal Medya İkonları (Altta) */}
            <div className="flex flex-col gap-3">
              <h3 className="text-white font-black text-lg uppercase tracking-wider mb-1">TAKİP EDİN</h3>
              <div className="flex items-center gap-3">
                {/* Instagram: Siteye uyumlu mavi hover */}
                <a href="https://www.instagram.com/bilginpcmarket" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center w-11 h-11 rounded-full border border-slate-600 bg-transparent hover:border-[#3b82f6] hover:bg-[#3b82f6]/10 transition-all duration-300">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-400 group-hover:text-[#3b82f6] transition-colors">
                ...
                {/* YouTube: Siteye uyumlu mavi hover */}
                <a href="https://www.youtube.com/@bilginpcmarket" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center w-11 h-11 rounded-full border border-slate-600 bg-transparent hover:border-[#3b82f6] hover:bg-[#3b82f6]/10 transition-all duration-300">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="text-slate-400 group-hover:text-[#3b82f6] transition-colors">
                    <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                  </svg>
                </a>

                {/* WhatsApp: Orijinal Yeşil hover */}
