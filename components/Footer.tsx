    ...
    <footer className={`bg-[#09090b] border-t border-slate-800/80 pt-16 relative overflow-hidden flex flex-col items-center ${pathname?.includes('/product') ? 'pb-40 md:pb-8' : 'pb-8'}`}>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* 4. Sütun: Mobil Uygulama ve TAKİP EDİN (Razer Tarzı - Soft Renkler) */}
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* YouTube: Soft Kırmızı hover */}
                <a href="https://www.youtube.com/@bilginpcmarket" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center w-11 h-11 rounded-full border border-slate-600 bg-transparent hover:border-[#ef4444] hover:bg-[#ef4444]/10 transition-all duration-300">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="text-slate-400 group-hover:text-[#ef4444] transition-colors">
