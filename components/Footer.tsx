...
export default function Footer() {
 ...
 if (
  ...
  return (
    ...
    <img src="https://res.cloudinary.com/dtnbkoa9s/image/upload/q_auto/f_auto/v1781544026/iyzico_blue-1024x576_kl0i8d.png" alt="iyzico" className="h-6 object-contain filter invert brightness-0" />
