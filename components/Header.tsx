        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <div ref={hesabimRef} style={{ position: "relative" }}>
            <button 
              ...
              style={{
                display: "flex", alignItems: "center", gap: "6px", background: hesabimAcik ? "rgba(0, 229, 255, 0.1)" : "#18181b", color: hesabimAcik ? "#00e5ff" : "#fff", border: hesabimAcik ? "1px solid rgba(0, 229, 255, 0.3)" : "1px solid #27272a", borderRadius: "10px", padding: "8px 12px", cursor: "pointer", transition: "all 0.2s"
              }}>
            ...
            {hesabimAcik && (
              <div style={{
                ...
                <Link href="/kayit" onClick={() => setHesabimAcik(false)} style={{ display: "flex", alignItems: "center", gap: "10px", padding: "10px 12px", color: "#fff", textDecoration: "none", fontSize: "0.85rem", fontWeight: "600", borderRadius: "8px", transition: "background 0.2s" }}>
          ...
          <Link href="/sepet" style={{
            ...
            <span style={{ fontSize: "18px" }}>🛒</span>
            <span className="hidden sm:inline" style={{ fontWeight: "600", color: "#e4e4e7", fontSize: "0.85rem" }}>Sepetim</span>
            {sepetAdedi > 0 && (
              <span style={{ position: "absolute", top: "-5px", right: "-5px", background: "#00e5ff", color: "#000", fontSize: "0.75rem", fontWeight: "900", width: "20px", height: "20px", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "50%", boxShadow: "0 0 10px rgba(0,229,255,0.5)" }}>
                {sepetAdedi}
              </span>
            )}
          </Link>
