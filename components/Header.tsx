    ...
    <header style={{ 
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "12px 20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          {/* HAMBURGER BUTONU (Sadece Mobilde Çıkar, PC'de Asla Çıkmaz) */}
          <button 
        ...
        {/* SAĞ KISIM: Hesabım ve Sepet (Milimetrik Eşitlendi) */}
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <div ref={hesabimRef} style={{ position: "relative" }}>
            <button 
              ...
              style={{
                ...
                border: hesabimAcik ? "1px solid #00e5ff" : "1px solid #27272a",
                borderRadius: "10px",
                padding: "0 14px",
                height: "40px", // Tam Eşit Boyut
          ...
          <Link href="/sepet" style={{
            ...
            <span>🛒</span>
            <span className="hidden sm:inline" style={{ fontWeight: "800", color: "#e4e4e7", fontSize: "0.85rem" }}>Sepetim</span>
      ...
      {/* ŞEFİM: BURADA PC'DE HAMBURGERİ TAMAMEN SİLİYORUZ */}
