  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="hidden sm:flex items-center justify-center gap-6 mt-6">
        ...
        <button
          onClick={() => kaydir("sol")}
          className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:bg-site-accent hover:text-site-shell hover:border-site-accent transition-all duration-300 shadow-lg hover:scale-110"
        >
          <ChevronLeft className="w-5 h-5" />
        </button>

        {/* ➖ ORTADAKİ ZARİF ÇİZGİ */}
        <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-transparent via-site-accent/40 to-transparent rounded-full opacity-50"></div>
