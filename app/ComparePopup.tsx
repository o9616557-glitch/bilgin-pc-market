...
export default function ComparePopup() {
  ...
  return (
    // 🚀 Z-index 99 yapıldı (bildirimler üstte çıksın diye) ve telefonda "p-0" yapılarak tam ekran yapıldı!
    <div className="fixed inset-0 z-[99] flex items-center justify-center bg-black/90 backdrop-blur-md p-0 sm:p-4 animate-in fade-in duration-200">
      
      {/* 🚀 Telefonda köşeler dik (rounded-none), yükseklik tam ekran (h-full). Bilgisayarda normal. */}
      <div className="bg-[#09090b] sm:border border-slate-800 rounded-none sm:rounded-3xl w-full h-full sm:h-auto max-w-6xl sm:max-h-[90vh] flex flex-col shadow-[0_0_50px_rgba(0,229,255,0.1)] relative">
        
        {/* Üst Başlık */}
        <div className="flex justify-between items-start sm:items-center p-4 sm:p-5 border-b border-slate-800 shrink-0 bg-[#09090b] sm:rounded-t-3xl">
        ...
        {/* Karşılaştırma Alanı */}
        <div className="p-4 sm:p-6 overflow-x-auto overflow-y-auto flex-grow bg-[#09090b]">
        ...
        {/* Alt Panel */}
        <div className="p-4 sm:p-5 border-t border-slate-800 shrink-0 bg-[#050814] rounded-none sm:rounded-b-3xl flex justify-between items-center pb-8 sm:pb-5">
