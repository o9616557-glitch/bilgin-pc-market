    ...
    <>
      ...
      {addresses.length === 0 && !showForm ? (
        <div className="flex flex-col items-center justify-center min-h-[50vh] text-center px-4 mt-8 animate-in fade-in zoom-in duration-300">
          ...
          <p className="text-slate-400 text-sm font-medium max-w-md mb-8 leading-relaxed">Sistemde teslimat veya fatura adresiniz bulunmuyor. Canavar donanımları size ulaştırabilmemiz için hemen yeni bir adres ekleyin.</p>
