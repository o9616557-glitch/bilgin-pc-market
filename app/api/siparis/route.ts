      ...
      try {
        ...
        const mailSecenekleri = {
          ...
          html: `<div style="background-color: #09090b; color: #fff; padding: 30px; border-radius: 12px; text-align: center;">
            <h2 style="color: #00e5ff;">Siparişiniz Alındı! 🎉</h2>
            <p>Merhaba ${musteri?.ad || "Değerli Müşterimiz"}, siparişiniz sistemimize ulaştı. Havale/EFT işleminiz onaylandığında hazırlık aşamasına geçilecektir.</p>
            <h1 style="color: #ffffff; letter-spacing: 3px;">${siparisKodu}</h1>
            <p>Bilgin PC Market</p>
          </div>`
        };
