      ...
      <div className="w-full max-w-md bg-[#09090b] border border-white/10 rounded-3xl shadow-[0_0_50px_rgba(0,229,255,0.05)] p-8 relative z-10">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4 mb-6">
          ...
          <div className="relative">
            ...
            <input 
              type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Şifreniz" 
              className="w-full bg-[#050814] border border-white/10 rounded-xl py-3 pl-12 pr-4 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-[#00e5ff]/50 transition-colors" required
            />
          </div>
        ...
        <div className="pt-6 border-t border-white/10">
          <Link href="/checkout" className="w-full bg-white/5 border border-white/10 rounded-xl py-3.5 flex items-center justify-center gap-2 text-slate-300 hover:text-white hover:bg-white/10 transition-all font-bold text-sm uppercase tracking-wider group">
