...
// import { signIn } from "next-auth/react"; // Arka plan bağlandığında kullanılacak
  ...
  return (
    <div className="min-h-screen bg-[#050814] text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-[#09090b] border border-white/10 rounded-3xl shadow-[0_0_50px_rgba(0,229,255,0.05)] p-8 relative z-10">
        ...
        <p className="text-slate-400 text-sm mb-8 font-medium">Efsanevi donanımlara ulaşmak için hesabına gir.</p>
        ...
        <div className="text-center mb-6">
          <p className="text-slate-400 text-sm">
            Hesabın yok mu? <Link href="/kayit" className="text-[#00e5ff] font-bold hover:underline">Yeni Kayıt Oluştur</Link>
          </p>
        </div>
