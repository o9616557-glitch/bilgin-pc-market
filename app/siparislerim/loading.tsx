    ...
    <div className="min-h-screen bg-[#050814] text-white pt-12 pb-24 px-4 relative overflow-hidden font-sans">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 border-b border-slate-700 pb-6 mb-10">
          ...
          {/* 🚀 Daha Açık Renk Buton Hayaleti */}
          <div className="w-36 h-11 bg-slate-600/50 rounded-xl animate-pulse shadow-lg"></div>
        </div>

        {/* 🚀 SİPARİŞ KARTI HAYALETİ (Açık Gri Tonlar) */}
        <div className="flex flex-col gap-6">
          <div className="border border-slate-700 bg-[#0f111a]/80 rounded-2xl overflow-hidden shadow-xl">
            
            {/* Sipariş Üst Bar Hayaleti */}
            <div className="bg-[#161a24] border-b border-slate-700 p-4 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="p-5 flex flex-col sm:flex-row sm:items-center gap-5">
              ...
              <div className="w-20 h-20 bg-slate-500/40 rounded-xl animate-pulse shrink-0"></div>
              
              <div className="flex-1">
                {/* Yazı Hayaletleri */}
                <div className="h-4 bg-slate-500/50 rounded w-2/3 mb-3 animate-pulse"></div>
                <div className="h-4 bg-slate-500/40 rounded w-1/4 animate-pulse"></div>
              </div>
