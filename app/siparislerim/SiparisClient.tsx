            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 relative z-10">
              ...
              <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                <div className="flex items-center gap-2 bg-[#020617] border border-slate-800 rounded-xl px-3 py-2 flex-1 sm:flex-none">
                  ...
                  <select 
                    value={zamanFiltresi} 
                    onChange={(e) => setZamanFiltresi(e.target.value)}
                    className="bg-transparent text-xs sm:text-sm text-slate-300 font-bold outline-none cursor-pointer appearance-none w-full"
                  >
