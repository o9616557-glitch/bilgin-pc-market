...
export default function SistemlerimPage() {
  ...
  // 🚀 ŞIK SİLME PENCERESİ İÇİN KONTROL
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white font-sans p-4 sm:p-6 lg:p-8 relative overflow-clip">
      {/* 🚀 ARKA PLAN PARLAMASI (VIP ZÜMRÜT YEŞİLİ) */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[500px] bg-emerald-600 blur-[250px] opacity-[0.05] pointer-events-none rounded-full"></div>
      ...
      <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-5 lg:gap-8 relative z-10 items-start">
        ...
        {/* ➡️ SAĞ İÇERİK (Sistemler Merkezi) */}
        <div className="flex-1 flex flex-col min-w-0 gap-5 lg:gap-6 w-full">
          ...
          <div className="bg-[#0f172a] border border-slate-800 rounded-2xl p-5 sm:p-6 lg:p-8 shadow-xl relative overflow-hidden group flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
            <div className="absolute -top-20 -right-20 w-64 h-64 bg-emerald-500/10 blur-[60px] pointer-events-none rounded-full"></div>
            
            <div className="flex items-center gap-3 sm:gap-4 relative z-10">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#020617] border border-emerald-500/30 rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(16,185,129,0.2)] shrink-0">
              ...
              <div>
                ...
                <p className="text-emerald-400/80 text-xs sm:text-sm font-medium tracking-wide">
                  Toplam: <span className="font-black text-emerald-400">{sistemler.length}</span> Sistem
                </p>
              </div>
            </div>
          ...
          {yukleniyor ? (
            <div className="text-center py-20 text-emerald-400 font-black uppercase tracking-widest animate-pulse bg-[#0f172a] border border-slate-800 rounded-2xl shadow-xl">
            ...
            <div className="bg-[#0f172a] border border-slate-800 rounded-2xl p-10 sm:p-16 flex flex-col items-center justify-center text-center shadow-xl relative overflow-hidden">
              <div className="w-20 h-20 rounded-full bg-[#020617] border border-emerald-500/20 flex items-center justify-center mx-auto mb-6 shadow-[0_0_30px_rgba(16,185,129,0.1)]">
              ...
              <Link 
                href="/kendin-topla" 
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white px-8 py-3.5 rounded-xl font-black uppercase tracking-widest text-xs transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)]"
              >
            ...
            <div className="grid grid-cols-1 gap-6 sm:gap-8">
              {sistemler.map((sistem) => {
                ...
                return (
                  <div key={sistem._id} className="bg-[#0f172a] border border-slate-800 rounded-2xl p-5 sm:p-8 flex flex-col lg:flex-row gap-6 lg:gap-8 shadow-xl transition-all hover:border-emerald-500/40 hover:shadow-[0_0_30px_rgba(16,185,129,0.05)] group">
                    
                    {/* SOL TARAF: SİSTEM BİLGİLERİ */}
                    <div className="w-full lg:w-1/3 flex flex-col border-b lg:border-b-0 lg:border-r border-slate-800/80 pb-6 lg:pb-0 lg:pr-8">
                      <div className="flex-1">
                        <div className="text-[10px] text-slate-500 font-black tracking-widest uppercase mb-2 flex items-center gap-2">
                          <Server className="w-3.5 h-3.5 text-emerald-400" /> Özel Sistem
                        </div>
                        <h2 className="text-xl sm:text-2xl font-black text-white leading-tight mb-2 break-words group-hover:text-emerald-400 transition-colors">{sistem.name}</h2>
                      ...
                      {/* BÜYÜK EKRAN BUTONLARI */}
                      <div className="hidden lg:flex flex-col gap-3">
                        <button 
                          onClick={() => handleSepeteEkle(sistem)}
                          className="w-full py-4 rounded-xl font-black uppercase tracking-widest text-xs bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white transition-all shadow-[0_0_15px_rgba(16,185,129,0.3)] flex justify-center items-center gap-2"
                        >
                    ...
                    <div className="w-full lg:w-2/3 flex flex-col">
                      ...
                      {/* 🚀 AKILLI OKLU KAYDIRMA SARMALAYICISI (Sensörlü) */}
                      <div className="relative flex-1 group mt-2">
                        ...
                        {parcalar.length > 4 && (
                          <button 
                            ...
                            className="up-ok-btn absolute -top-3 left-1/2 -translate-x-1/2 z-20 w-8 h-8 flex items-center justify-center bg-[#020617]/90 hover:bg-emerald-500/20 border border-slate-700 hover:border-emerald-500/50 rounded-full text-slate-400 hover:text-emerald-400 backdrop-blur-xl transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0.8)] opacity-0 pointer-events-none hover:scale-110"
                          >
                        ...
                        >
                          {parcalar.map((urun: any, i: number) => (
                            <div key={i} className="flex items-start gap-3 bg-[#020617] p-3 rounded-xl border border-slate-800 relative z-10 transition-colors hover:border-emerald-500/30">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="text-[9px] text-emerald-400 font-black uppercase tracking-wider mb-1 flex items-center gap-1">
                          ...
                          {parcalar.length > 0 && (
                            <div className="col-span-1 md:col-span-2 flex items-center justify-center pt-6 pb-2 opacity-50 select-none">
                              ...
                              <div className="mx-4 text-emerald-500/50 text-xs drop-shadow-[0_0_8px_rgba(16,185,129,0.8)]">◆</div>
                        ...
                        {parcalar.length > 4 && (
                          <button 
                            ...
                            className="down-ok-btn absolute -bottom-3 left-1/2 -translate-x-1/2 z-20 w-8 h-8 flex items-center justify-center bg-[#020617]/90 hover:bg-emerald-500/20 border border-slate-700 hover:border-emerald-500/50 rounded-full text-slate-400 hover:text-emerald-400 backdrop-blur-xl transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0.8)] opacity-100 hover:scale-110"
                          >
                      ...
                      {/* MOBİL EKRAN BUTONLARI */}
                      <div className="flex lg:hidden flex-col gap-3 mt-6 pt-6 border-t border-slate-800/80">
                        <button 
                          onClick={() => handleSepeteEkle(sistem)}
                          className="w-full py-4 rounded-xl font-black uppercase tracking-widest text-xs bg-gradient-to-r from-emerald-600 to-teal-600 text-white transition-all shadow-[0_0_15px_rgba(16,185,129,0.3)] flex justify-center items-center gap-2"
                        >
                          <ShoppingBag className="w-4 h-4" /> Sistemi Sepete Ekle
                        </button>
                        <button 
