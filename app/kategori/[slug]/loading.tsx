export default function Loading() {
  return (
    // 🔥 1. SINIRSIZ DIŞ KATMAN: Sağdaki ve soldaki o dev boşlukları uçtan uca SİMSİYAH boyar 🔥
    <div className="w-full min-h-screen bg-black text-white pt-24 pb-24 font-sans">

      {/* 🔥 2. İÇ KATMAN: Sadece ürünlerin ve filtrelerin durduğu 1400px'lik ortalanmış alan 🔥 */}
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 animate-in fade-in duration-300">

        {/* 1. ÜST BAŞLIK ALANI İSKELETİ */}
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <main className="flex-1 w-full min-w-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div key={i} className="w-full h-[400px] bg-[#09090b] rounded-3xl animate-pulse flex flex-col p-5">
                  {/* Resim Alanı */}
