      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-[380px] shrink-0">
          <div className="bg-[#09090b] border border-slate-800/50 rounded-3xl p-6 lg:p-8 sticky top-24">
            ...
            <div className="flex justify-between items-center text-white font-black border-t border-slate-800 pt-6 mb-8">
              <span className="text-lg">Genel Toplam</span>
              <span className="text-2xl lg:text-3xl text-[#00e5ff]">{genelToplam.toLocaleString("tr-TR")} <span className="text-base text-slate-400 font-bold">TL</span></span>
            </div>
