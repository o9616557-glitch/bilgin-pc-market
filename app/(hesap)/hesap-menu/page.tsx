      ...
      <nav className="flex-1 min-h-0 overflow-y-auto px-3 py-2 flex flex-col gap-0.5">
        {NAV_ITEMS.map((item) => (
          <Link
            ...
            href={item.href}
            prefetch
            className="flex items-center gap-3 px-4 py-3.5 rounded-2xl text-[15px] font-medium transition-all text-slate-300 hover:text-white hover:bg-white/[0.05] active:bg-white/[0.08]"
          >
