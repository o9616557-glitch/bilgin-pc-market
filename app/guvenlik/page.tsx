...
import { 
  ...
  PowerOff, AlertTriangle, Snowflake, Trash2, MapPin 
} from "lucide-react";
...
export default function GuvenlikPage() {
  ...
  // Şifre gücünü hesaplayan ufak motor (0 ile 4 arası)
    ...
    <div className="min-h-screen bg-[#020617] text-white font-sans p-4 sm:p-6 lg:p-8 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-6 relative z-10">
        ...
        <div className="flex-1 flex flex-col min-w-0 gap-6">
          ...
          {/* 🛡️ 1. SATIR: ŞİFRE VE İKİ ADIMLI DOĞRULAMA */}
            ...
            <div className="bg-[#0f172a] border border-slate-800 rounded-2xl p-6 shadow-xl flex flex-col h-full">
              ...
              <div className="flex flex-col gap-4 flex-1">
                <div>
                  ...
                  <input type="password" placeholder="••••••••" className="w-full bg-[#020617] border border-slate-800 focus:border-cyan-500/50 rounded-xl px-4 py-3 text-white text-sm outline-none transition-all focus:shadow-[0_0_15px_rgba(6,182,212,0.1)]" />
                </div>
              ...
              <button className="mt-6 w-full py-3.5 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-black text-xs uppercase tracking-widest transition-all shadow-[0_0_20px_rgba(6,182,212,0.2)]">
                ŞİFREYİ GÜNCELLE
              </button>
            </div>
